...
public class TrenerPocetniView extends JFrame {
	public TrenerPocetniView() {
		...
		springLayout.putConstraint(SpringLayout.SOUTH, btnNewButton_1, -6, SpringLayout.NORTH, btnNewButton_2);
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                List<Takmicenje> lista = new TakmicenjaRepository().getAllCompetitions();
                IstorijaTakmicenjaView istorija = new IstorijaTakmicenjaView(lista);
